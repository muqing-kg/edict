...
<p align="center">
  <strong>太空舰载系统欢迎每一位贡献者 ⚔️</strong><br>
...
我们推荐用"指令"的格式来描述你的需求 —— 目标、约束、预期产出写清楚就够了 😄
...
如果你的工作是“吸收上游仓库的新提交”，除了完成 merge 本身，还需要同步维护说明文档：

- 每次同步完成后，更新 [`docs/upstream-sync-log.md`](docs/upstream-sync-log.md)
- 记录内容至少包括：
  - 上游来源与基准提交
  - 本次吸收了哪些新增内容
  - 哪些本地定制被刻意保留
...
<p align="center">
  <sub>感谢每一位贡献者，你们是舰载系统持续演进的基石 ⚔️</sub>
</p>
