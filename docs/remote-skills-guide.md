...
舰载系统现已支持从网上连接和增补 skills 资源，无需手动复制文件。支持从以下来源获取：
...
- `sourceUrl` (string, 必需): 远程 URL 或本地文件路径
  ...
  - 本地: `file:///Users/xxx/skills/code_review.md` 或 `/Users/xxx/skills/code_review.md`
...
{
  "ok": true,
  "message": "技能 code_review 已添加到 xingshu",
  "skillName": "code_review",
  "agentId": "xingshu",
  "source": "https://raw.githubusercontent.com/...",
  "localPath": "/Users/xxx/.openclaw/workspace-xingshu/skills/code_review/SKILL.md",
  "size": 2048,
...
|-----------|------|----------|--------|
| `code_review` | 代码审查（支持 Python/JS/Go） | 维控/探针 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/code_review/SKILL.md |
| `api_design` | API 设计审查 | 维控/机务 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/api_design/SKILL.md |
| `security_audit` | 安全审计 | 探针 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/security_audit/SKILL.md |
| `data_analysis` | 数据分析 | 源流 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/data_analysis/SKILL.md |
| `doc_generation` | 文档生成 | 文枢 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/doc_generation/SKILL.md |
| `test_framework` | 测试框架设计 | 机务/探针 | https://raw.githubusercontent.com/openclaw-ai/skills-hub/main/test_framework/SKILL.md |

**一键导入官方 skills**

```bash
python3 scripts/skill_manager.py import-skills-hub \
  --agents xingshu,lengjing,zhongji,weikong,tanzhen,wenshu
```
...
compatibleAgents: [weikong, tanzhen, lengjing]
---
...
A: 检查文件格式：
```bash
python3 -m json.tool ~/.openclaw/workspace-xingshu/skills/xxx/SKILL.md
```
